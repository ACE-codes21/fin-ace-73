    ...
    <Layout>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/chat">
                  <Button className="bg-finance-primary hover:bg-finance-primary/90 text-white px-6 py-5">
                    Get Started <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>
                <Link to="/forecast">
                  <Button variant="outline" className="border-finance-primary text-finance-primary hover:bg-finance-primary/10 px-6 py-5">
            ...
            <div className="md:w-1/2 mt-12 md:mt-0">
              <div className="bg-gradient-to-br from-finance-primary/20 to-finance-accent/20 p-1 rounded-2xl shadow-xl">
                <img 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-finance-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-finance-secondary/10 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-finance-accent/10 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <section className="bg-gradient-to-r from-finance-primary to-finance-accent py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/chat">
            <Button className="bg-white text-finance-primary hover:bg-gray-100 px-8 py-6 text-lg">
